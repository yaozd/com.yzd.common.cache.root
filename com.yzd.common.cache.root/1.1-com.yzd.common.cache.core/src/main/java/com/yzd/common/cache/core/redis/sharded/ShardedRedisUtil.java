...
import com.yzd.common.cache.core.redis.wrapper.CachedWrapper;
import com.yzd.common.cache.core.redis.wrapper.CachedWrapperExecutor;
import com.yzd.common.cache.core.utils.fastjson.FastJsonRedisSerializer;
...
public class ShardedRedisUtil {
    ...
    public <T> String set(final String key, T object) {
        String value = FastJsonRedisSerializer.serializeFormDate(object);
        return set(key, value);
    }

    public <T> T get(final String key, Class<T> clz) {
        String value = get(key);
        return FastJsonRedisSerializer.deserialize(value, clz);
    }
    ...
    public <T> List<T> getList(final String key, Class<T> clz) {
        String value = get(key);
        return FastJsonRedisSerializer.deserializeList(value, clz);
    }
