package com.yzd.common.cache.core.utils.fastjson;
...
/**
 * fastjson 对象序列化
 * 关闭循环引用检测的功能,可以用效的提高性能
 */
public class FastJsonRedisSerializer {
    private FastJsonRedisSerializer() {
        throw new IllegalStateException("Utility class-FastJsonRedisSerializer");
    }
